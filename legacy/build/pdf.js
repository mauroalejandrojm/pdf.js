...
if (typeof globalThis === "undefined" || !globalThis._pdfjsCompatibilityChecked) {
  ...
  (function checkReadableStream() {
    ...
    globalThis.ReadableStream = (__w_pdfjs_require__(133).ReadableStream);
  })();
}
...
(function (global, factory) {
  ...
  function fromMatrix(m) {
    ...
    if ([CSSMatrix, DOMMatrix].some(function (x) {
      return m instanceof x;
    }) || _typeof(m) === 'object' && keys.every(function (k) {
      return k in m;
    })) {
  ...
  function fromString(source) {
    ...
    var is2D = true;
    var tramsformObject = str.split(')').filter(function (f) {
      return f;
    }).map(function (fn) {
      var ref = fn.split('(');
      var prop = ref[0];
      ...
      if (is2D && (prop === 'matrix3d' || prop === 'rotate3d' && [x, y].every(function (n) {
        return !Number.isNaN(+n) && n !== 0;
      }) && a || ['rotateX', 'rotateY'].includes(prop) && x || prop === 'translate3d' && [x, y, z].every(function (n) {
        return !Number.isNaN(+n);
      }) && z || prop === 'scale3d' && [x, y, z].every(function (n) {
        return !Number.isNaN(+n) && n !== x;
      }))) {
        is2D = false;
      }
    ...
    tramsformObject.forEach(function (tf) {
      ...
      } else if (['translate', 'translate3d'].some(function (p) {
        return prop === p;
      }) && x) {
  ...
  var CSSMatrix = function CSSMatrix() {
    ...
    if (args && args.length) {
      ...
      if (args instanceof Array) {
        if (args[0] instanceof Array && [16, 6].includes(args[0].length) || typeof args[0] === 'string' || [CSSMatrix, DOMMatrix].some(function (x) {
          return args[0] instanceof x;
        })) {
  ...
  CSSMatrix.prototype.setMatrixValue = function setMatrixValue(source) {
    ...
    if ([DOMMatrix, CSSMatrix].some(function (x) {
      return source instanceof x;
    })) {
  ...
  CSSMatrix.prototype.toArray = function toArray() {
    ...
    return result.map(function (n) {
      return Math.abs(n) < 1e-6 ? 0 : (n * pow6 >> 0) / pow6;
    });
  };
...
var promiseResolve = __w_pdfjs_require__(123);
var hostReportErrors = __w_pdfjs_require__(125);
var newPromiseCapabilityModule = __w_pdfjs_require__(124);
var perform = __w_pdfjs_require__(126);
var InternalStateModule = __w_pdfjs_require__(52);
var isForced = __w_pdfjs_require__(68);
var wellKnownSymbol = __w_pdfjs_require__(37);
var IS_BROWSER = __w_pdfjs_require__(127);
var IS_NODE = __w_pdfjs_require__(119);
var V8_VERSION = __w_pdfjs_require__(31);
...
var IS_IOS = __w_pdfjs_require__(118);
var IS_IOS_PEBBLE = __w_pdfjs_require__(121);
var IS_WEBOS_WEBKIT = __w_pdfjs_require__(122);
var IS_NODE = __w_pdfjs_require__(119);
...
var anObject = __w_pdfjs_require__(49);
var isObject = __w_pdfjs_require__(24);
var newPromiseCapability = __w_pdfjs_require__(124);
...
var charAt = (__w_pdfjs_require__(132).charAt);
var toString = __w_pdfjs_require__(103);
var InternalStateModule = __w_pdfjs_require__(52);
var defineIterator = __w_pdfjs_require__(78);
...
var InternalRenderTask = /*#__PURE__*/function () {
  function InternalRenderTask(_ref20) {
    var callback = _ref20.callback,
        ...
        annotationCanvasMap = _ref20.annotationCanvasMap,
...
var pdfjsVersion = '2.12.273';
var pdfjsBuild = '97dc048e5';
{
  if (_is_node.isNodeJS) {
